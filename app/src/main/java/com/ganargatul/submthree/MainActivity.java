...
import com.ganargatul.submthree.fragment.MovieFragment;
import com.ganargatul.submthree.fragment.TvFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMovieTvAdapter = new MovieTvAdapter(this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_movie) {
            mMovieTvAdapter.cleardata();
            moveFragment(new MovieFragment());
        } else if (id == R.id.nav_tv) {
            mMovieTvAdapter.cleardata();
            moveFragment(new TvFragment());
        }
